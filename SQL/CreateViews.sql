...
Begin DesignProperties =
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'appinfo'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'appinfo'
GO
...
/****** Object:  View [dbo].[smtpconfiguration]    Script Date: 12/27/2019 3:58:50 PM ******/
SET ANSI_NULLS ON
GO
...
Begin DesignProperties =
   ...
   Begin DiagramPane =
      ...
      End
      Begin Tables =
         Begin Table = "notificationsystem"
            Begin Extent =
               Top = 6
               Left = 38
               Bottom = 136
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'smtpconfiguration'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'smtpconfiguration'
GO
